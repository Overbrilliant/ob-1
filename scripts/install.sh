...
#   curl -fsSL https://github.com/overbrilliant/ob-1/releases/latest/download/install.sh | sh -s -- --version v0.1.4
#
# Local repo install:
...
Usage:
  install.sh [--version v0.1.4] [--repo owner/name] [--install-dir DIR]
  install.sh --release [--version v0.1.4]
  install.sh --launcher
  install.sh --binary
