...
check("recoveryHint auth covers managed, Free models, and Custom API", /ob1 login/.test(recoveryHint("API 401: invalid api key")) && /\/free/.test(recoveryHint("API 401: invalid api key")) && /\/models/.test(recoveryHint("API 401: invalid api key")));
